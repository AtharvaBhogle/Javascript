...
//console.log(printNum(100,200,300,400));//it prints only 100 before adding rest  operator and prints everyting after rest operator
...
function useObj(obj) {
    console.log(`username is ${obj.username} and password is ${obj.pass}`);
}
//console.log(useObj(obj7));// this is one way another is 
console.log(useObj(onjNew={
    username:"new",
    pass:"newpass"
}));// this is another way by defining the new obj in the log statement

//USING ARRAY
const lol=[100,200,300,400]
function useArr(arr){
    return arr[2]
}
console.log(useArr(lol));
console.log(useArr([88,99,11,22,11]));